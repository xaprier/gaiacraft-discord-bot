    ...
    run: async (client, message, args) => {
        ...
        if (user.permissions.has("ADMINISTRATOR")) {
            var embed = new MessageEmbed()
                ...
                .addFields(
                    { name: `Minecraft Sunucu Adresimiz;`, value: `mc.gaiacraft.net` },
                    { name: `Web Adresimiz;`, value: `https://gaiacraft.net/` },
                    { name: `Discord Adresimiz;`, value: `https://discord.gg/NdA3nZrufW` },
                    { name: `Instagram Adresimiz;`, value: `https://www.instagram.com/mcgaiacraft/` },
