...
module.exports = {
    ...
    run: async (client, message, args) => {
        ...
        var embed = new MessageEmbed().setFooter({ text: `Developed by XAPRIER`, iconURL: message.guild.members.cache.get(config.developer).avatarURL() }).setTimestamp().setAuthor({ name: ``, iconURL: message.guild.iconURL({ dynamic: true }) }).setColor("ORANGE");
